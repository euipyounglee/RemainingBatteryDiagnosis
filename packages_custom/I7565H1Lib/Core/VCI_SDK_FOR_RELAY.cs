...
namespace I7565H1Lib.Core
{
	public class VCI_SDK_FOR_RELAY
	{
        ...
        [DllImport(DLLNAME)]
        ////private const string str1 = Path.GetTempPath() + "..\\myLibFolder\\VCI_CAN_FOR_RELAY.dll";
        //[DllImport(str1)]
		...
		[DllImport(DLLNAME)]
	//	private const string str1 = Path.GetTempPath() + "..\\myLibFolder\\VCI_CAN_FOR_RELAY.dll";
	//	private const string str1 = @"d:\pmgrow\SynologyDrive\work_job\BatteryDiagnosis\Remaining.BatteryDiagnosis\run\Debug\\VCI_CAN_FOR_RELAY.dll";
		//[DllImport(str1)]
