...
namespace RelayBoxLib.Core
{
	public class Core : I7565H1Lib.Core.AI7565H1
	{
		...
		public  Core() : base(typeof(I7565H1Lib.Core.VCI_SDK_FOR_RELAY), LogDev.RELAY_BOX, 1)
		{
			Init();
		}
		...
		public void RecvCANMsg(byte CANNo)
		{
            ...
            if ( IsLogWrite )
            {
				...
				Console.WriteLine($"[Recv] CANID: 0x{string.Format("{0:X}", canId)}, {StringHelper.ByteArrayToHexString(data)}");
            }
